  ...
  return (
    <main className="min-h-screen pb-20 bg-[#f8faff]">
      ...
      <div className="max-w-6xl mx-auto mt-6 md:mt-10 px-4">
        ...
        <div className="hidden md:grid grid-cols-5 bg-gray-50 p-4 rounded-t-[2rem] border-x border-t border-gray-100 text-[10px] font-black text-gray-400 uppercase tracking-widest">
            <div className="px-4 col-span-2">Squadra / Giocatori</div>
            <div className="px-4">Torneo</div>
            <div className="px-4">Data Iscr.</div>
            <div className="px-4 text-right">Stato</div>
        </div>
        ...
        <div className="space-y-4 md:space-y-0 md:bg-white md:rounded-b-[2rem] md:shadow-xl md:border md:border-gray-100 md:divide-y">
            {filteredIscrizioni.map((req) => (
                <div key={req.id} className="bg-white p-6 rounded-[2rem] shadow-xl md:shadow-none md:rounded-none md:grid md:grid-cols-5 md:items-center hover:bg-emerald-50/10 transition-all">
                    {/* Squadra e Giocatori */}
                    ...
                    {/* Stato Badge */}
                    <div className="flex items-center md:justify-end md:px-4">
                        {req.stato === "In Attesa" ? (
