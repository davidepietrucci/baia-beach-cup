          ...
          <form className="space-y-6 animate-fade-in" onSubmit={handleSubmit}>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-t-8" style={{ borderColor: "#295dab" }}>
              ...
              <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl">
                <label className="block text-xs font-black text-[#295dab] uppercase tracking-wider mb-2">Torneo Attivo</label>
                <select 
                  name="torneo"
                  required
                ...
                >
                  {torneiAperti.map((t, idx) => (
                    <option key={idx} value={t.nome}>{t.nome} - {t.data} {t.categoria ? `(${t.categoria.replace(/maschile 2x2/gi, "2x2")})` : ''}</option>
                  ))}
                </select>
              </div>
            </div>
            ...
            {activeTorneo?.tipoIscrizione === "esterno" ? (
              <div className="bg-white rounded-2xl shadow-xl p-8 border-t-8 border-indigo-600 space-y-6 text-center">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-black text-[#295dab]">Iscrizione tramite Google Moduli</h3>
